...
league_name = "1. LIGA KÖLN UND SCHALKE"  # Name of your league, must be exact match, can be done via env or hardcoded
start_budget = 50_000_000               # Starting budget of your league, used to calculate current budgets of other managers
league_start_date = "2025-07-19"        # Start date of your league, used to filter activities, format: YYYY-MM-DD
email = os.getenv("jonathan1908schmidt@gmail.com")         # Email to send recommendations to, can be the same as EMAIL_USER or different
